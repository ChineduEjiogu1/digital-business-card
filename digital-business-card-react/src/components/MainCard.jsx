    ...
    return (
        <>
            <div className='container'>
                ...
                <img className='main-img' src={picOfMe} alt="Picture of me" />
                </div>
                <div className='sub-container'>
                    <h2 className='name'>Chinedu Ejiogu</h2>
                    ...
                    <div className='connect'>
                        <a className='mail' href="mailto:chineduejiogu@gmail.com"><img src={mail} alt="mail" /> Email</a>
